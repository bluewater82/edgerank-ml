...
## Overview
Stocker is a machine learning-driven trading signal system designed to identify high-confidence short-term price movement in equities. The project evolves from a simple data pipeline into a structured, experiment-driven framework for generating, filtering, and evaluating trading signals.
